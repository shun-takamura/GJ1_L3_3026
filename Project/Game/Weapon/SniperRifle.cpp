...
/// </summary>
bool SniperRifle::TryRangedAttack(float dt, bool triggered, bool held, const Vector3& ownerPos,
...
void SniperRifle::DrawImGuiTuning() {
	...
	ImGui::Separator();
	ImGui::DragFloat("Damage", &kDamage, 0.5f, 0.0f, 150.0f);
